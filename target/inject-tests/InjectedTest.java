...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","F:\\goat-pc-data\\ecworkspace\\20140712-jenkins-plugin-hello101");
    parameters.put("artifactId","hello101");
    parameters.put("outputDirectory","F:\\goat-pc-data\\ecworkspace\\20140712-jenkins-plugin-hello101\\target\\classes");
    parameters.put("testOutputDirectory","F:\\goat-pc-data\\ecworkspace\\20140712-jenkins-plugin-hello101\\target\\test-classes");
